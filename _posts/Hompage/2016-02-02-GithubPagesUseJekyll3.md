...
Jekyll 3.0 기본세팅에서는 작성시각이 UTC +00 기준으로 설정된다.  
2016.02.02 23:00 로 입력했을 경우 영국시각으로 인식되고 우리나라 시각으로는 02.03 08:00 가 되는 것이다.  

config에 아래와 같이 입력을 하면 우리나라 시각을 이용해서 편하게 이용할 수 있다.
