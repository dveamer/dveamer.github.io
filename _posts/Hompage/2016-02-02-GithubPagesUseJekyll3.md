...
Jekyll 3.0을 설치하고 config에 kramdown, rouge를 설정하 후 
기존에 작성한 포스트들의 마크다운 문법들을 수정했습니다.

이 포스트를 작성 후 몇일 뒤 [Bundler를 이용한 Jekyll 3.0 업그레이드]() 방법을 알게됐습니다.
이 방법은 기존의 마크다운 문법을 수정할 필요가 없습니다.
