...
개념적으로만 알고 있던 새로운 기술을 사용해보고  
혼자 진행하기 때문에 모든 역할을 다 수행하기 때문에 다양한 이슈들을 경험해볼 수 있었습니다.  
Side-Proejct를 통해 많은 성장을 이뤘다고 개인적으로 생각합니다.  

항상 모든 역할을 다 수행하는 것만도 아닙니다.  
...
상황에 의해 프레임워크 없이 순수 Java로 Servlet 프로그래밍을 통해 웹 서비스를 진행한 경험도 있습니다.  
